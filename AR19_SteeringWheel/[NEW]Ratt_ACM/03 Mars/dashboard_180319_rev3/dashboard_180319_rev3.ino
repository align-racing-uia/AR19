...
// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! //
  ...
  //Pin number setup
  const int iButtonPins[4] = {4, 5, 0, 0}; //?Add ocrrect button pin numbers - In order: Left button, Right Button, Left Flappy, Right Flappy
...
void setup() {
  ...
  debuggingMSG.data[1] = 1;
  debuggingMSG.data[2] = 1;
  debuggingMSG.data[3] = 1;

...
uint16_t uiRotarySwitchPositionRaw = 0;
...
void CheckRotarySwitch()
{
  ...
  {
    //File error
    Serial.println("Rotary switch out of range signals detected");
    delay(3000);
  }

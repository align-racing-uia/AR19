...
//Tested with two buttons successfully
...
//??? for testing ONLY: usage of serial functions (Serial.begin/print) and delay
  ...
  //Misc. Constants
  const long lReleaseWithin = 100; //(ms). Must be <= 500. ?Add better time
...
void loop() {
 ...
 // Serial.print( IsBothButtonsPressed() ); Serial.print(" "); Serial.print(!bLaunchActive); Serial.print(" \n");
 // Serial.print( bButtonValues[0] && bButtonValues[1] ); Serial.print(" \n");

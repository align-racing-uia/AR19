...
const uint8_t signalHysteresisValue = 15; //how much larger or smaller the value must be than the limit before triggering a value change. A mechanical solution would render this fairly unneccesary.
const uint8_t numberOfIntervals = 15; //?example
...
{
  uiRotarySwitchPositionRaw = 0; //analogRead(iRotarySwitchPin);

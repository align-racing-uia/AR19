void GearDown(){
  ...
  if (cansignal::gearDownSignal == global::sant && millis()-timerGearDown > gearTimerTimeout && millis()-timerGearUp > gearTimerTimeout && gearposition::currentGear >= 2 && cansignal::engineRPM < downshiftRPMLimit && millis() - gotoneutral::timerNeutralTimeout > gotoneutral::neutralTimeout + gotoneutral::safeTime && clutchpressure::InBar < clutchpressure::engagedTreshold)
    {
